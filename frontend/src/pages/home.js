              ...
              <div id="heroCarousel" data-bs-interval="5000" className="container carousel carousel-fade" data-bs-ride="carousel">
                ...
                <div className="carousel-item active">
                  <div className="carousel-container">
                    ...
                    <p className="animate__animated animate__fadeInUp">Methane Anomaly Detector identifies potential methane emission anomalies in California using data from Sentinel 5P, a satellite launched by the European Space Agency.</p>
