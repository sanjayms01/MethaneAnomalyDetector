                    ...
                    <Tab.Content>
                        <Tab.Pane eventKey="first">
                            <p id="dwld-box-cz" style={{textAlign: 'left'}}>
                                ...
                                To better understand what climate zones are and to locate your zone, refer to {(currentPage == 'Model') ? <a href="https://methaneanomalydetector.com/explore#data_explorer_intro" target="_blank">Zone Details</a> : <HashLink to="/explore#data_explorer_intro">Zone Details</HashLink>}.
                                To better understand each of the time series columns, refer to the glossary in {(currentPage == 'Model') ? <a href="https://methaneanomalydetector.com/explore#data_comparison" target="_blank">Data Comparison</a> : <HashLink to="/explore#data_comparison">Data Comparison</HashLink>}.
                                <br/>
                                <br/>
                        ...
                        <Tab.Pane eventKey="second">
                            <p id="dwld-box-full" style={{textAlign: 'left'}}>
                                ...
                                To better understand the rounded resolution columns, refer to {(currentPage == 'Model') ? <a href="https://methaneanomalydetector.com/explore#missing_data" target="_blank">Missing Data</a> : <HashLink to="/explore#missing_data">Missing Data</HashLink>}.
                                To better understand each of the time series columns, refer to the glossary in {(currentPage == 'Model') ? <a href="https://methaneanomalydetector.com/explore#data_comparison" target="_blank">Data Comparison</a> : <HashLink to="/explore#data_comparison">Data Comparison</HashLink>}.
                                <br/>
                                <br/>
